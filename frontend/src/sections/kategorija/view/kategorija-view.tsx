...
import { UserTableHead } from '../kategorija-table-head';
import { TableEmptyRows } from '../table-empty-rows';
import { UserTableToolbar } from '../kategorija-table-toolbar';
import { emptyRows, applyFilter, getComparator } from '../utils';

// ----------------------------------------------------------------------

export function KategorijaView() {
                ...
                {dataFiltered
                  ...
                  .map((row) => (
                    <UserTableRow
                      ...
                      onSelectRow={() => table.onSelectRow(String(row._id))}
                    />
                  ))}
